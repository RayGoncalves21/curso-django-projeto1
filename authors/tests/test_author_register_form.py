...
class AuthorRegisterFormIntegrationTest(DjangoTestCase):
    ...
    @parameterized.expand([
        ('username', 'esse campo não pode ficar vazio'),
    ...
    def test_username_field_max_length_should_be_4(self):
        self.form_data['username'] = 'jo' * 151
        url = reverse('authors:create')
        response = self.client.post(url, data=self.form_data, follow=True)

        msg = 'Username must have have less than 150 characters'
    ...
    def test_password_and_password_confirmation_are_equal(self):
        ...
        msg = 'Password and confirmation must be equal'
